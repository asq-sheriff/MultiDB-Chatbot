...
class EnhancedMongoConnectionManager:
        ...
        try:
            ...
            try:
                ...
                if "$vectorsearch is not supported" in error_msg:
                    logger.info("âŒ $vectorSearch not supported - not Atlas Local")
                    return False
    ...
    async def create_vector_search_index(
        ...
        try:
            ...
            logger.error(f"âŒ SearchIndexModel not available - motor/pymongo version issue: {e}")
            return False
        except Exception as e:
            ...
            if "already exists" in str(e).lower():
                ...
                return True
            logger.error(f"âŒ Failed to create vector search index: {e}")
            return False
    ...
    async def vector_search(
        ...
        logger.warning("âŒ No vector search method available")
        return []
    ...
    async def _atlas_vector_search(
        ...
        try:
            ...
            logger.error(f"âŒ Atlas vector search operation failed: {e}")
            ...
            logger.error(f"âŒ Unexpected Atlas vector search error: {e}")
    ...
    async def _manual_vector_search(
        ...
        try:
            ...
            logger.error(f"âŒ Manual vector search failed: {e}")
            return []
    ...
    def _cosine_similarity(self, a: List[float], b: List[float]) -> float:
        ...
        try:
            ...
            logger.error(f"âŒ Cosine similarity calculation failed: {e}")
            return 0.0
    ...
    async def _create_traditional_indexes(self):
        ...
        try:
            ...
            logger.error(f"âŒ Failed to create traditional indexes: {e}")
            raise
    ...
    async def _create_vector_search_indexes(self):
        ...
        for collection_name in collections_to_index:
            try:
                ...
                logger.error(f"âŒ Failed to create vector search index for {collection_name}: {e}")
    ...
    async def disconnect(self) -> None:
        ...
        try:
            ...
            logger.error(f"âŒ Error during MongoDB disconnect: {e}")
        finally:
            self.client = None
            self.database = None
...
async def init_enhanced_mongo() -> bool:
    ...
    try:
        ...
        logger.error(f"âŒ Enhanced MongoDB initialization failed: {e}")
        return False
