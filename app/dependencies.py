    ...
    if knowledge_service is None:
        try:
            ...
            if hasattr(embedder, 'embed_query'):
                knowledge_service = KnowledgeService(query_embedder=embedder.embed_query)
            else:
...
__all__ = [
    'get_embedding_service', 'get_generation_service', 'get_knowledge_service',
    'get_chatbot_service', 'get_billing_service', 'get_auth_service',
    'get_user_service', 'get_multi_db_service', 'get_scylla_manager',
    'get_postgres_manager',
    'get_db_session', 'get_postgres_session',
    'embedding_service', 'generation_service', 'knowledge_service',
    'chatbot_service', 'billing_service', 'auth_service', 'user_service',
    'multi_db_service', 'scylla_manager',
    'reset_services',
]